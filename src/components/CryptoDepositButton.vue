  ...
  <div id="app">
    ...
    <form class="__apr-constructor-form">
      ...
      <div class="__apr-constructor-container">
        <button type="button" class="__apr-constructor-button" v-b-modal.depositModal>
        ...
        <b-modal id="depositModal" title="" ok-only :header-bg-variant="headerBgVariant"
          :footer-bg-variant="footerBgVariant" :header-text-variant="headerTextVariant">
          <div class="content">
